...
- MCP server annotations live in **`org.springframework.ai.mcp.server.annotation`**
  in Spring AI 2.0. (In the 1.1 line they were in the `org.springaicommunity.mcp`
  incubator — do not use that package here.)
- Spring AI 2.0 defaults to **Streamable HTTP**; SSE is deprecated. Keep
  `spring.ai.mcp.server.protocol: STREAMABLE`.

## Layout

Base package `com.example.productcrudmcp`. Everything must stay under it so component
